...
@MainActor
enum WitnessIntentContainer {
    static let shared: ModelContainer = {
        do {
            let schema = Schema([WitnessItem.self])
...
struct TimestampTextIntent: AppIntent {
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        let container = WitnessIntentContainer.shared
...
struct OpenWitnessIntent: AppIntent {
    nonisolated static let title: LocalizedStringResource = "Open Witness"
    nonisolated static let description = IntentDescription("Open the Witness app")
...
struct WitnessShortcuts: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        AppShortcut(
            ...
            phrases: [
                ...
                "Witness text in \(.applicationName)",
